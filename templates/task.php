<tr class="tasks__item task <?php if ($task["is_complete"]): ?>task--completed<?php endif; ?> <?php if (isset($task["task_date"]) && !$task["is_complete"] && is_important_task($task["task_date"])): ?>task--important<?php endif; ?>">
